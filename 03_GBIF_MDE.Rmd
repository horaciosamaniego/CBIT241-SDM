...
6.  General 2 modelos de distribución para cada grupo de ocurrencias.
...
d.  ¿En qué se diferencian las evaluaciones generadas por el ROC y las métricas umbral dependientes, como Kapa o prevalencias?
d.  (bonus) Reconstruye la matriz de confusión para los 2 grupos (las
    ocurrencias del norte y las del sur)

### Predicción

7.  Indica cual es la predicción para la distribución de *C. patagus*
