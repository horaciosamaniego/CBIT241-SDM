...
6.  General 2 modelos de distribución para cada grupo de ocurrencias.
    Esto es, usa el modelos estadísticos *glm* para explicar la
...
b.  Genera 2 predicciones de distribucion, una con calibración, la del
    norte y la del sur para predecir sobre toda el área
...
d.  ¿En qué se diferencian las evaluaciones generadas por el ROC y las
    métricas umbral dependientes, como Kapa o prevalencias?
